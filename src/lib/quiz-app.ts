...
const labels: Record<LocaleCode, { best: string; worst: string; next: string; complete: string }> = {
  ...
  it: { best: "Mi descrive di più", worst: "Mi descrive di meno", next: "Conferma e continua", complete: "Vedi risultati" },
  uk: { best: "Найбільше про мене", worst: "Найменше про мене", next: "Підтвердити і далі", complete: "Переглянути результат" },
  ar: { best: "ينطبق عليّ كثيراً", worst: "ينطبق عليّ قليلاً", next: "تأكيد ومتابعة", complete: "عرض النتيجة" },
  tr: { best: "Beni en çok tanımlayan", worst: "Beni en az tanımlayan", next: "Onayla ve Devam Et", complete: "Sonucu Gör" },
  nl: { best: "Trifft het meest op mij", worst: "Trifft het minst op mij", next: "Bevestigen en doorgaan", complete: "Bekijk resultaat" },
  pl: { best: "Najbardziej pasuje", worst: "Najmniej pasuje", next: "Zatwierdź i kontynuuj", complete: "Zobacz wynik" },
  vi: { best: "Giống tôi nhất", worst: "Khác tôi nhất", next: "Xác nhận và tiếp tục", complete: "Xem kết quả" },
  th: { best: "ตรงกับฉันมากที่สุด", worst: "ตรงกับฉันน้อยที่สุด", next: "ยืนยันและดำเนินการต่อ", complete: "ดูผลลัพธ์" },
  id: { best: "Paling menggambarkan", worst: "Paling tidak menggambarkan", next: "Konfirmasi dan lanjutkan", complete: "Lihat hasil" },
  sv: { best: "Passar bäst in", worst: "Passar minst in", next: "Bekräfta och fortsätt", complete: "Visa resultat" },
};
...
const traitNames: Record<LocaleCode, Record<Trait, string>> = {
  ...
  pt: { O: "Abertura", C: "Conscienciosidade", E: "Extroversão", A: "Amabilidade", N: "Sensibilidad emocional" },
...
const radarTraitNames: Record<LocaleCode, Record<Trait, string>> = {
  ...
  it: { O: "Apertura", C: "Coscienza", E: "Estroversione", A: "Gradevolezza", N: "Sensibilità" },
  uk: { O: "Відкритість", C: "Сумлінність", E: "Екстраверсія", A: "Доброзичлив.", N: "Емоційність" },
  ar: { O: "الانفتاح", C: "تفاني الضمير", E: "الانبساط", A: "القبول", N: "الحساسية" },
  tr: { O: "Açıklık", C: "Sorumluluk", E: "Dışadönüklük", A: "Uyumluluk", N: "Duygusallık" },
  nl: { O: "Openheid", C: "Zorgvuldig.", E: "Extraversie", A: "Vriendelijk.", N: "Gevoeligheid" },
  pl: { O: "Otwartość", C: "Sumienność", E: "Ekstrawersja", A: "Ugodowość", N: "Wrażliwość" },
  vi: { O: "Cởi mở", C: "Tận tụy", E: "Hướng ngoại", A: "Dễ chịu", N: "Nhạy cảm" },
  th: { O: "เปิดรับ", C: "ระเบียบ", E: "แสดงตัว", A: "เป็นมิตร", N: "ไวต่ออารมณ์" },
  id: { O: "Keterbukaan", C: "Kehati-hatian", E: "Ekstraversi", A: "Keramahan", N: "Sensitivitas" },
  sv: { O: "Öppenhet", C: "Samvetsgrann", E: "Extraversion", A: "Vänlighet", N: "Känslighet" },
};
...
const traitExplain: Record<LocaleCode, Record<Trait, string>> = {
  ...
  hi: {
    ...
    E: "सामाजिक मेलजول, अभिव्यक्ति और बाहरी प्रेरणा से प्राप्त ऊर्जा।",
  ...
  it: {
    O: "Interesse per nuove idee, concetti astratti e prospettive alternative.",
    C: "Pianificazione, stabilità nell'esecuzione e attenzione alla qualità.",
    E: "Energia ottenuta dall'interazione sociale e dall'espressione.",
    A: "Empatia, cooperazione e attenzione ai sentimenti altrui.",
    N: "Sensibilità allo stress, ai rischi e ai cambiamenti emotivi.",
  },
  uk: {
    O: "Інтерес до нових ідей, абстрактних концепцій та альтернативних поглядів.",
    C: "Планування, стабільність виконання та увага до якості.",
    E: "Енергія від соціальної взаємодії, самовираження та зовнішніх стимулів.",
    A: "Емпатія, співпраця та увага до почуттів інших людей.",
    N: "Чутливість до стресу, ризиків та емоційних коливань.",
  },
  ar: {
    O: "الاهتمام بالأفكار الجديدة والمفاهيم المجردة والرؤى البديلة.",
    C: "التخطيط واستقرار التنفيذ والاهتمام بالجودة.",
    E: "الطاقة المستمدة من التفاعل الاجتماعي والتعبير والتحفيز.",
    A: "التعاطف والتعاون والاهتمام بمشاعر الآخرين.",
    N: "الحساسية تجاه التوتر والمخاطر والتقلبات العاطفية.",
  },
  tr: {
    O: "Yeni fikirlere, soyut kavramlara ve alternatif bakış açılarına ilgi.",
    C: "Planlama, uygulama istikrarı ve kaliteye verilen önem.",
    E: "Sosyal etkileşimden, kendini ifadeden ve dış uyaranlardan alınan enerji.",
    A: "Empati, işbirliği ve başkalarının duygularına gösterilen özen.",
    N: "Strese, risklere ve duygusal değişimlere karşı hassasiyet.",
  },
  nl: {
    O: "Interesse in nieuwe ideeën, abstracte concepten en alternatieve perspectieven.",
    C: "Planning, stabiliteit in uitvoering en oog voor kwaliteit.",
    E: "Energie uit sociale interactie, expressie en externe prikkeling.",
    A: "Empathie, samenwerking en aandacht voor de gevoelens van anderen.",
    N: "Gevoeligheid voor stress, risico's en emotionele schommelingen.",
  },
  pl: {
    O: "Zainteresowanie nowymi pomysłami, abstrakcyjnymi pojęciami i nowymi perspektywami.",
    C: "Planowanie, stabilność w realizacji oraz dbałość o jakość.",
    E: "Energia płynąca z interakcji społecznych i ekspresji.",
    A: "Empatia, współpraca i troska o uczucia innych.",
    N: "Wrażliwość na stres, ryzyko i wahania emocjonalne.",
  },
  vi: {
    O: "Hứng thú với ý tưởng mới, khái niệm trừu tượng và góc nhìn thay thế.",
    C: "Lập kế hoạch, sự ổn định trong thực thi và chú trọng chất lượng.",
    E: "Năng lượng từ tương tác xã hội, bộc lộ bản thân và kích thích bên ngoài.",
    A: "Thấu cảm, hợp tác và quan tâm đến cảm xúc người khác.",
    N: "Sự nhạy cảm với căng thẳng, rủi ro và biến động cảm xúc.",
  },
  th: {
    O: "ความสนใจในความคิดใหม่ๆ แนวคิดที่เป็นนามธรรม และมุมมองทางเลือก",
    C: "การวางแผน ความเสถียรในการทำงาน และการใส่ใจในคุณภาพ",
    E: "พลังงานจากการปฏิสัมพันธ์ทางสังคม การแสดงออก และสิ่งเร้าภายนอก",
    A: "ความเห็นอกเห็นใจ การทำงานร่วมกัน และการใส่ใจในความรู้สึกของผู้อื่น",
    N: "ความไวต่อความเครียด ความเสี่ยง และการเปลี่ยนแปลงทางอารมณ์",
  },
  id: {
    O: "Minat pada ide-ide baru, konsep abstrak, dan perspektif alternatif.",
    C: "Perencanaan, stabilitas eksekusi, dan perhatian pada kualitas.",
    E: "Energi dari interaksi sosial, ekspresi, dan stimulasi eksternal.",
    A: "Empati, kerja sama, dan perhatian pada perasaan orang lain.",
    N: "Sensitivitas terhadap stres, risiko, dan pergeseran emosional.",
  },
  sv: {
    O: "Intresse för nya idéer, abstrakta koncept och nya perspektiv.",
    C: "Planering, stabilitet i utförande och omsorg om kvalitet.",
    E: "Energi från social interaktion, uttryck och yttre stimulans.",
    A: "Empati, samarbete och omsorg om andras känslor.",
    N: "Känslighet för stress, risker och emotionella svängningar.",
  },
};
...
const levelNames: Record<LocaleCode, string[]> = {
  ...
  it: ["Molto basso", "Basso", "Moderato", "Alto", "Molto alto"],
  uk: ["Дуже низький", "Низький", "Середній", "Високий", "Дуже високий"],
  ar: ["منخفض جداً", "منخفض", "متوسط", "مرتفع", "مرتفع جداً"],
  tr: ["Çok düşük", "Düşük", "Orta", "Yüksek", "Çok yüksek"],
  nl: ["Zeer laag", "Laag", "Gemiddeld", "Hoog", "Zeer hoog"],
  pl: ["Bardzo niski", "Niski", "Średni", "Wysoki", "Bardzo wysoki"],
  vi: ["Rất thấp", "Thấp", "Trung bình", "Cao", "Rất cao"],
  th: ["ต่ำมาก", "ต่ำ", "ปานกลาง", "สูง", "สูงมาก"],
  id: ["Sangat rendah", "Rendah", "Sedang", "Tinggi", "Sangat tinggi"],
  sv: ["Mycket låg", "Låg", "Måttlig", "Hög", "Mycket hög"],
};
...
async function renderPoster(
  ...
  const line1Map: Partial<Record<LocaleCode, string>> = {
  ...
  const line2Map: Partial<Record<LocaleCode, string>> = {
